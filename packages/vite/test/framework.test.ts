...
// @ts-nocheck`;
    ...
    expect(vueTemplateSource.startsWith(generatedHeader)).toBe(true);
    ...
    expect(react.startsWith(generatedHeader)).toBe(true);
    ...
    expect(vanillaAutoImport.startsWith(generatedHeader)).toBe(true);
