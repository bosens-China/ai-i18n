...
function generatedTypeHeader(): string {
  return `/**
...
${RUNTIME_API_NAMES.map((name) =>
  ...
  const vueTemplateReference = vueTemplateTypesReference
    ? `\n\n/// <reference path="${vueTemplateTypesReference}" />`
    : '';

  return `${generatedTypeHeader()}${vueTemplateReference}
