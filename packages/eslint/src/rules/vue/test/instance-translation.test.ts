...
import plugin, { noUnsubscribedT } from '../../../index';

const fixtureRoot = path.resolve(
  'packages/eslint/src/rules/vue/test/fixtures/instance-translation',
);
...
describe('Vue instance translation syntax', () => {
  ...
  it('provides Chinese and English instance-member diagnostics', async () => {
    try {
      ...
      vi.resetModules();
      const chinese = await import('../../common/no-unsubscribed-t.js');
      expect(
      ...
      vi.resetModules();
      const english = await import('../../common/no-unsubscribed-t.js');
      expect(
